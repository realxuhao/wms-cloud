...
class MaterialInServiceImplTest {
    ...
    @Test
    void testSelectMaterialInList() {
        // Setup
        final MaterialInDTO materialInDTO = new MaterialInDTO();
        materialInDTO.setId(0L);
        materialInDTO.setSsccNumber("ssccNumber");
        materialInDTO.setBatchNb("batchNb");
        materialInDTO.setMaterialNb("materialNb");
        materialInDTO.setCheckType(0);
        materialInDTO.setCheckQuantity(0);
        materialInDTO.setMinStandard(0.0);
        materialInDTO.setMaxStandard(0.0);
        materialInDTO.setActualQuantity(0);
        materialInDTO.setActualResult(0.0);
        materialInDTO.setAverageResult(0.0);
        ...
        // Run the test
        final List<MaterialInVO> result = materialInServiceImplUnderTest.selectMaterialInList(materialInDTO);
    ...
    @Test
    void testSelectMaterialInList_MaterialInMapperReturnsNoItems() {
        // Setup
        final MaterialInDTO materialInDTO = new MaterialInDTO();
        materialInDTO.setId(0L);
        materialInDTO.setSsccNumber("ssccNumber");
