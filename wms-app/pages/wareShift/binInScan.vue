			...
			<uni-popup ref="distributionLine" type="dialog">
				...
				<view>
					<view class="text-align m-b-4">
						<text class="label m-r-8">订单号:</text><text>{{barCodeInfo.orderNumber}}</text>
					</view>
					<view class="text-align m-b-4">
						<text class="label m-r-8">动作类型:</text><text>{{moveTypeMap[barCodeInfo.type]}}</text>
					</view>
					<view class="text-align">
						<text class="label m-r-8">Cell:</text><text>{{barCodeInfo.cell}}</text>
					</view>
				</view>
