...
import Pending from './receivingPending';
import Completed from './receivingCompleted';
...
export default {
	...
	methods: {
		...
		handleGotoScan() {
			uni.navigateTo({
				url: '/pages/materialCall/receivingOperation'
			});
		}
	}
};
