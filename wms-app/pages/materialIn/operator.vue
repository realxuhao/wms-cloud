		...
		<view class="main" slot="page-main">
			...
			<view class="content">
				<uni-forms :label-width="80" v-if="materialInfo.checkType === 1" ref="numberform" :rules="numberRules" :modelValue="numberFormData" label-position="left">
					...
					<uni-forms-item label="数数结果" name="actualResult" required><uni-easyinput v-model="numberFormData.actualResult" placeholder="数数结果" /></uni-forms-item>
			...
			<view class="result-content">
				<view class="result-status">
					<uni-icons
						...
						:type="resultData.checkFlag ? 'icon-chenggong' : 'icon-shibai'"
						size="32"
					></uni-icons>
