...
<script>
	...
	export default {
		...
		mounted() {
			// this.getSample('11221025101012358660208716900568763172407093700006000669006391110024506')
		},
		methods: {
			...
			async getSample(barCode) {
				try {
					uni.showLoading();
					const data = await this.$store.dispatch('finishedProduct/spdnGetByQrCode', barCode);
