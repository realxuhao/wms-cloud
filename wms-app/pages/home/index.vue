		...
		<view class="main">
			<uni-section title="采购原材料"
				...
				<view class="list header-box">
					...
					<view class="list-item" v-if="$hasPermi(['app:material:batchBinIn'])"
						...
						<uni-icons custom-prefix="iconfont" class="icon icon-fenpishangjia"
							type="icon-fenpishangjia"></uni-icons>
			...
			<uni-section title="仓内管理"
				...
				<view class="list header-box">
					...
					<view class="list-item" v-if="$hasPermi(['app:manualTrans:scan'])"
						@click="handleGoto('/pages/splitPallet/scan')">
						<uni-icons custom-prefix="iconfont" class="icon icon-chaifen" color="#1afa29"></uni-icons>
						<view class="text">拆托</view>
					</view>
					<view class="list-item" v-if="$hasPermi(['app:splitPallet:binIn'])"
						@click="handleGoto('/pages/splitPallet/binIn')">
					...
					<view class="list-item" v-if="$hasPermi(['app:location:scan'])"
						@click="handleGoto('/pages/location/scan')">
					...
					<view class="list-item" v-if="$hasPermi(['app:location:adjust'])"
						@click="handleGoto('/pages/adjust/adjustScan')">
			...
			<uni-section title="移库业务"
				...
				type="line" class="m-b-12">
				<view class="list header-box">
					<view class="list-item" v-if="$hasPermi(['app:wareShift:binDown'])"
						@click="handleGoto('/pages/wareShift/binDown')">
						<uni-icons custom-prefix="iconfont" class="icon baocaixiajiabeiliao"
							type="icon-baocaixiajiabeiliao" color="#00ADD4"></uni-icons>
						<view class="text">移库下架</view>
					</view>
					<view class="list-item" v-if="$hasPermi(['app:materialCall:shipment'])"
						@click="handleGoto('/pages/materialCall/shipment')">
					...
					<view class="list-item" v-if="$hasPermi(['app:wareShift:receiving'])"
						@click="handleGoto('/pages/wareShift/receiving')">
					...
					<view class="list-item" v-if="$hasPermi(['app:wareShift:binIn'])"
						@click="handleGoto('/pages/wareShift/binIn')">
						<uni-icons custom-prefix="iconfont" class="icon icon-xiehuo" type="icon-shangjia2"
							color="#1afa29"></uni-icons>
			...
			<uni-section title="IQC质检"
				...
				<view class="list header-box" v-if="$hasPermi(['app:iqc:binDown'])">
					...
					<view class="list-item" v-if="$hasPermi(['app:iqc:sample'])"
						@click="handleGoto('/pages/IQC/sample')">
	...
	export default {
		...
		methods: {
			async downWgt() {
				...
				const {
					data: downloadUrl
				} = await fileService.getFileUrl('wmsnew.apk');
