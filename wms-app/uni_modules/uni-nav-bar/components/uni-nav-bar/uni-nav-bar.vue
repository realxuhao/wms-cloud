      ...
      >
        ...
        >
          <slot name="left">
            <view class="uni-navbar__content_view" v-if="leftIcon.length > 0">
              <uni-icons color="#fff" :type="leftIcon" size="20" />
            </view>
            <view
        ...
        >
          <slot name="right">
            ...
            >
              <text class="uni-nav-bar-right-text" :style="{ color: '#fff' }">{{
                rightText
              }}</text>
            </view>
          </slot>
    ...
    themeBgColor() {
      if (this.dark) {
        ...
        if (this.backgroundColor) {
          ...
          return this.dark ? "#333" : "#541b86";
        }
      }
      return this.backgroundColor || "#541b86";
    },
    themeColor() {
      if (this.dark) {
        // 默认值
