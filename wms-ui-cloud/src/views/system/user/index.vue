              ...
              <a-row :gutter="48">
                ...
                <a-col :span="4">
                  <a-form-item label="所属公司" >
                    <a-select v-model="queryParam.deptId" placeholder="请选择所属公司" style="width: 100%" allow-clear>
                      <a-select-option v-for="item in deptOptions" :key="item.id" :value="item.id">{{ item.label }}</a-select-option>
                    </a-select>
                  </a-form-item>
                </a-col>
