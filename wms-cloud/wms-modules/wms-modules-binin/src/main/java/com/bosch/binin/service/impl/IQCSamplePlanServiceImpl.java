...
//        samplePlan.setStatus(AreaListConstants.mainArea(stock.getAreaCode())? IQCStatusEnum.WAITING_BIN_DOWN.code() : IQCStatusEnum.WARE_SHIFTING.code());
        ...
        if (!AreaListConstants.mainArea(stock.getAreaCode())) {
            List<WareShift> wareShiftList = new ArrayList<>();
...
//        }
    ...
    public void cancel(Long id) {
        ...
        if (!AreaListConstants.mainArea(samplePlan.getAreaCode())) {
            //移库任务
